...
public class PruebaMatch extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		TransactionModel tm1 = new TransactionModel("1", "EUR", "GBP", 10.0, new Date(), 0.015);
		cal.add(cal.DATE, -1);
		TransactionModel tm2 = new TransactionModel("1", "GBP", "EUR", 7.96, cal.getTime(), 0.015);
		cal.add(cal.DATE, 4);
		TransactionModel tm3 = new TransactionModel("1", "EUR", "USD", 10.0, cal.getTime(), 0.015);
		cal.add(cal.DATE, 2);
		TransactionModel tm4 = new TransactionModel("1", "USD", "GBP", 10.0, cal.getTime(), 0.015);
		cal.add(cal.DATE, -20);
		TransactionModel tm5 = new TransactionModel("1", "EUR", "USD", 10.0, cal.getTime(), 0.015);
