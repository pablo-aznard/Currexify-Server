	...
	<div class="content">
		...
		<div style="width: 100%;">
			...
			<div style="width: 90%; margin-left: 5%;">
				<div>
					<paper-input label="Usuario"
						value="<c:if test="${user != null}"><c:out value="${user}" /></c:if>"></paper-input>
				...
				<div style="margin-top: 2em;">
					<div style="display: inline-block; width: 49.5%">
						...
						<p>
							<span>¿No estás registrado?<a href="{{baseUrl}}register">Regístrate</a></span>
						</p>
					</div>
					<div style="display: inline-block; width: 49.5%">
